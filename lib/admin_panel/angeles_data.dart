...
class AngelesData extends StatefulWidget {
  const AngelesData({Key? key}) : super(key: key);

  @override
  State<AngelesData> createState() => _AngelesDataState();
}

class _AngelesDataState extends State<AngelesData> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    controller: _resorttimeController,
                    decoration: const InputDecoration(labelText: 'Resort Time'),
                  ),
                  TextField(
                    controller: _contactinfoController,
  ...
  Future<void> _delete(String productId) async {
    await _angeles.doc(productId).delete();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          child: StreamBuilder(
              stream: _angeles.orderBy('name', descending: false).snapshots(),
