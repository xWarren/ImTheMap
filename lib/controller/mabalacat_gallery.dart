...
class MabalacatGallery extends StatelessWidget {
  final DocumentSnapshot mabalacatimage;
  const MabalacatGallery({Key? key, required this.mabalacatimage}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    bool myMarkerThumb = true;
    List swimmingpool = [
      mabalacatimage['image1'],
      mabalacatimage['image2'],
    ];

    List lobby = [

      mabalacatimage['image3'],
      mabalacatimage['image4'],
    ];

    List room = [
      mabalacatimage['image5'],
      mabalacatimage['image6'],
    ];

    List dining = [
      mabalacatimage['image7'],
      mabalacatimage['image8'],
    ];
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image:  myMarkerThumb != 'noImage'
                                        ? NetworkImage(mabalacatimage['image1'])
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image:  myMarkerThumb != 'noImage'
                                        ? NetworkImage(mabalacatimage['image3'])
                                        : AssetImage('assets/no_image.jpg') as ImageProvider,
                                    fit: BoxFit.fill
                                )
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image:  myMarkerThumb != 'noImage'
                                        ? NetworkImage(mabalacatimage['image5'])
                                        : AssetImage('assets/no_image.jpg') as ImageProvider,
                                    fit: BoxFit.fill
                                )
                            ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image:  myMarkerThumb != 'noImage'
                                        ? NetworkImage(mabalacatimage['image7'])
                                        : AssetImage('assets/no_image.jpg') as ImageProvider,
                                    fit: BoxFit.fill
                                )
                            ),
